...
- **Carried to Plan 05:** aggregate→HAVING + auto-GROUP-BY; subquery operands; moving `common_field_for/1` (Plan 02) into `PredicateBuilder`; the end-to-end wiring of `PredicateBuilder` → thin adapter.

defmodule EctoShorts.ActionsTest do
  ...
  describe "all/2" do
    ...
    test "returns matching records where field is an array type, no operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["should_not_see_this"]})

      assert [%EctoShorts.Schemas.Post{tags: ["example"]}] =
               Actions.all(Post, %{tags: "example"})
    end

    test "returns matching records where field is an array type, :== is operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["should_not_see_this"]})
    ...
    test "returns matching records where field is an array type, :eq is operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["should_not_see_this"]})

      assert [%EctoShorts.Schemas.Post{tags: ["example"]}] =
               Actions.all(Post, %{tags: %{eq: "example"}})
    end
    ...
    test "returns matching records where field is an array type, :!= is operator, value is a scalar" do
      ...
      assert [%EctoShorts.Schemas.Post{tags: ["example"]}] =
               Actions.all(Post, %{tags: %{!=: "should_not_see_this"}})
    end

    test "returns matching records where field is an array type, :not is operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["should_not_see_this"]})

      assert [%EctoShorts.Schemas.Post{tags: ["example"]}] =
               Actions.all(Post, %{tags: %{not: "should_not_see_this"}})
    end

    test "returns matching records by lexographical comparison where field is an array type, :< is operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["A"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["B"]})

      assert [%EctoShorts.Schemas.Post{tags: ["B"]}] =
               Actions.all(Post, %{tags: %{<: "A"}})
    end

    test "returns matching record by lexographical comparison where field is an array type, :lt is operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["A"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["B"]})

      assert [%EctoShorts.Schemas.Post{tags: ["B"]}] =
               Actions.all(Post, %{tags: %{lt: "A"}})
    end
    ...
    test "returns matching records by lexographical comparison where field is an array type, :> is operator, value is a scalar" do
      ...
      assert [%EctoShorts.Schemas.Post{tags: ["A"]}] =
               Actions.all(Post, %{tags: %{>: "B"}})
    end

    test "returns matching record by lexographical comparison where field is an array type, :gt is operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["A"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["B"]})

      assert [%EctoShorts.Schemas.Post{tags: ["A"]}] =
               Actions.all(Post, %{tags: %{gt: "B"}})
    end
    ...
    test "returns matching records by lexographical comparison where field is an array type, :<= is operator, value is a scalar" do
      ...
      assert [%EctoShorts.Schemas.Post{tags: ["A"]}, %EctoShorts.Schemas.Post{tags: ["B"]}] =
               Actions.all(Post, %{tags: %{<=: "A"}})
    end

    test "returns matching record by lexographical comparison where field is an array type, :lte is operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["A"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["B"]})

      assert [%EctoShorts.Schemas.Post{tags: ["A"]}, %EctoShorts.Schemas.Post{tags: ["B"]}] =
               Actions.all(Post, %{tags: %{lte: "A"}})
    end
    ...
    test "returns matching records by lexographical comparison where field is an array type, :>= is operator, value is a scalar" do
      ...
      assert [%EctoShorts.Schemas.Post{tags: ["A"]}, %EctoShorts.Schemas.Post{tags: ["B"]}] =
               Actions.all(Post, %{tags: %{>=: "C"}})
    end

    test "returns matching record by lexographical comparison where field is an array type, :gte is operator, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["A"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["B"]})

      assert [%EctoShorts.Schemas.Post{tags: ["A"]}, %EctoShorts.Schemas.Post{tags: ["B"]}] =
               Actions.all(Post, %{tags: %{gte: "C"}})
    end

    test "matches records case insensitively where field is an array type, :== operator with :lower, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_3 = Testing.insert!(Repo, Post, %{tags: ["should_not_see_this"]})

      assert [
               %EctoShorts.Schemas.Post{tags: ["example"]},
               %EctoShorts.Schemas.Post{tags: ["example"]}
             ] =
               Actions.all(Post, %{tags: %{==: %{lower: "example"}}})
    end

    test "matches records case insensitively where field is an array type, :== operator with :upper, value is a scalar" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_3 = Testing.insert!(Repo, Post, %{tags: ["should_not_see_this"]})
      ...
      assert [
               ...
               Actions.all(Post, %{tags: %{==: %{upper: "EXAMPLE"}}})
    end
    ...
    test "matches records case insensitively where field is an array type, :!= operator with :lower, value is a scalar" do
      ...
      assert [
               ...
               Actions.all(Post, %{tags: %{!=: %{lower: "should_not_see_this"}}})
    end
    ...
    test "matches records case insensitively where field is an array type, :!= operator with :upper, value is a scalar" do
      ...
      assert [
               ...
               Actions.all(Post, %{tags: %{!=: %{upper: "SHOULD_NOT_SEE_THIS"}}})
    end

    test "matches records case insensitively where field is an array type, :== operator with :lower, value is a list of strings" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_3 = Testing.insert!(Repo, Post, %{tags: ["should_not_see_this"]})
    ...
    test "matches records case insensitively where field is an array type, :== operator with :upper, value is a list of strings" do
      _post_1 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_2 = Testing.insert!(Repo, Post, %{tags: ["example"]})
      _post_3 = Testing.insert!(Repo, Post, %{tags: ["should_not_see_this"]})

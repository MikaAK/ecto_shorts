defmodule EctoShorts.QueryBuildersTest do
  ...
  # A minimal module that exports build_query/6.
  ...
  describe "build_query/6 adapter resolution" do
    ...
    test "uses opts[:query_builder_module] override at runtime over the default adapter" do
    ...
    test "raises ArgumentError when opts[:query_builder_module] is not a module atom" do
      assert_raise ArgumentError, ~r/Expected :query_builder option to be a module/, fn ->
        QueryBuilders.build_query(
          ...
          {:as, nil},
          10,
          query_builder_module: "not_a_module"
        )
      end
    end
  end
